...
export default function SurveyForm({ onSubmit }) {
  ...
  return (
    <div className="max-w-4xl mx-auto px-6 py-8">
      ...
      <div>
        <p>
            O GUIDO (Grupo de Pais e Amigos pela Unidade InfantoJuvenil de Onco-hematologia) é um grupo de pessoas dedicadas, profissionais de saúde, pais e voluntários que se reuniram para apoiar as famílias que viajavam de longe em busca de tratamento para seus filhos.
        </p>
          <br />
          <p className="text-pink-50 leading-relaxed">
            O GUIDO evoluiu para a Casa GUIDO, uma OSC comprometida com o bem-estar de crianças e adolescentes com câncer. Desde 2010, temos sido um farol de esperança para famílias em busca de tratamento. Nossa casa acolhedora oferece não apenas tratamento médico, mas também amor, apoio e refeições para aqueles que estão longe de casa. Ajudamos com o transporte, medicamentos, terapias e educação, criando um ambiente onde o sorriso é mais forte do que o câncer.
          </p>
          <br />
          <p className="text-pink-50 leading-relaxed">
            A Casa GUIDO é uma luz na escuridão do câncer pediátrico. Somos um lembrete de que, juntos, podemos superar qualquer desafio e encher os corações de crianças com a luz da esperança. Junte-se a nós nesta jornada de amor e cura.
          </p>
        </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              <div>
                ...
                >
                  ...
                  <option value="hospedagem">Hospedagem na Casa GUIDO</option>
                  <option value="transporte">Transporte para tratamento</option>
                  <option value="medicamentos">Auxílio com medicamentos</option>
                  <option value="terapias">Terapias e apoio psicológico</option>
                  <option value="educacao">Apoio educacional</option>
                  <option value="alimentacao">Refeições e alimentação</option>
