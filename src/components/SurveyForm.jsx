...
export default function SurveyForm({ onSubmit, isDarkMode }) {
  ...
  if (isSubmitted) {
    return (
      <div className="max-w-3xl mx-auto px-6 py-12">
        <div className={`rounded-3xl shadow-xl border p-12 text-center transition-all duration-300 ${
          isDarkMode
          ...
          <p className={`text-lg mb-6 transition-all duration-300 ${
  ...
  return (
    <div className="max-w-4xl mx-auto px-6 py-8">
      ...
      <div className={`rounded-3xl shadow-xl border overflow-hidden transition-all duration-300 ${
        isDarkMode
          ? 'bg-gray-800 border-gray-600'
          : 'bg-white border-pink-100'
      }`}>        
        <form onSubmit={handleSubmit} className="p-10 space-y-10">
          ...
          <div className={`rounded-3xl p-8 border transition-all duration-300 ${
            ...
            <h3 className={`text-2xl font-bold mb-6 flex items-center space-x-3 transition-all duration-300 ${
              isDarkMode ? 'text-gray-200' : 'text-gray-700'
            }`}>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div>
                ...
                <input
                  ...
                  className={`w-full px-5 py-4 border-2 rounded-2xl focus:ring-4 focus:ring-pink-200 focus:border-pink-400 transition-all text-lg shadow-sm ${
                    isDarkMode
          ...
          <div className="space-y-10">
            {/* Satisfação geral */}
            <div>
              <label className={`block text-xl font-bold mb-6 transition-all duration-300 ${
            ...
            <div>
              ...
              <div className="flex justify-center">
                <div className={`flex gap-3 p-6 rounded-3xl shadow-lg border transition-all duration-300 ${
                  isDarkMode
                    ? 'bg-gray-700 border-gray-600'
              ...
              <p className={`text-center text-base mt-4 font-medium transition-all duration-300 ${
                isDarkMode ? 'text-gray-400' : 'text-gray-600'
              }`}>Clique nas estrelas para avaliar (1 a 5 estrelas)</p>
            </div>
            ...
            <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                {[
                  ...
                  <label key={improvement} className={`flex items-center cursor-pointer p-4 rounded-2xl transition-all border shadow-sm hover:shadow-md ${
                    isDarkMode
                    ...
                    />
                    <span className={`ml-4 font-semibold text-base transition-all duration-300 ${
                      isDarkMode ? 'text-gray-300' : 'text-gray-700'
                    }`}>{improvement}</span>
                  </label>
                ))}
            ...
            <div>
              ...
              <textarea
                ...
                rows={6}
                className={`w-full px-6 py-5 border-2 rounded-2xl focus:ring-4 focus:ring-pink-200 focus:border-pink-400 transition-all resize-none text-lg shadow-sm ${
                  isDarkMode
                    ? 'bg-gray-600 border-gray-500 text-gray-200 placeholder-gray-400'
                    : 'bg-white border-pink-200 text-gray-700 placeholder-gray-500'
                }`}
